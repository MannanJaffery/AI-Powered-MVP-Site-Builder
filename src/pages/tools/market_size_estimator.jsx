...
const {
  ...
  isLimited,
  incrementUsage,
} = useUsageLimit("MarketSizeEstimate", 8); 
...
useEffect(() => {
  const interval = setInterval(() => {
    if (isLimited) {
      ...
      const history = usageData["MarketSizeEstimate"] || [];
        ...
        <div className="px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-3">
              {/* Usage Counter - visible on all screens */}
